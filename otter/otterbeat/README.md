...
curl -X POST -H 'Content-Type: application/json' "http://192.168.108.11:30008/custom" -d '{"ipPort":"172.30.51.228","keys":["otter","pipeline","1","inserts"],"time":"20240516104448","category":"departed-otter-health-check-02","values":[{"metricType":"Gauges","name":"V","val":15}]}'
curl -X POST -H 'Content-Type: application/json' "http://192.168.108.11:30008/custom" -d '{"ipPort":"172.30.51.228","keys":["otter","pipeline","1","updates"],"time":"20240516104458","category":"departed-otter-health-check-02","values":[{"metricType":"Gauges","name":"V","val":3}]}'
curl -X POST -H 'Content-Type: application/json' "http://192.168.108.11:30008/custom" -d '{"ipPort":"172.30.51.228","keys":["otter","pipeline","1","deletes"],"time":"20240516104628","category":"departed-otter-health-check-02","values":[{"metricType":"Gauges","name":"V","val":1}]}'
